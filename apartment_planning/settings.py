...
ALLOWED_HOSTS = ['proectcetr.ru', 'proectcentr.ru', 'proectcetr.ru.swtest.ru', 'proectcentr.ru.swtest.ru']
...
EMAIL_USE_TLS = False
EMAIL_USE_SSL = True
EMAIL_HOST_USER = 'proectcetr@yandex.ru'
EMAIL_HOST_PASSWORD = 'sdduxcrktaadarxb'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'user.context_processors.current_url'
            ],
        },
    },
]
